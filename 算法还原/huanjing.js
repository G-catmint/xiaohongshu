...
navigator = {
    ...
    clearAppBadge: function (){console.log("clearAppBadge", arguments)},
    getBattery: function (){console.log("getBattery", arguments)},
    getUserMedia: function (){console.log("getUserMedia", arguments)},
...
window.openDatabase = function (){console.log(arguments)}
window.devicePixelRatio = 1.5;
window.AudioContext = AudioContext;
window.setInterval = setInterval;
window.split = String.prototype.split;
window.Math = Math;
    ...
    function Sanji() {
        ...
        return function(_ace_4752e, _ace_aa949, _ace_be07c) {
            ...
            var _ace_99485 = function(_ace_2d9a) {
                // _ace_2d9a初始时是一个大数组, length 11119
...
document.cookie = 'abRequestId=1af71b9d-b893-5596-aa61-5f8ccd09cdf5; webBuild=4.12.3; xsecappid=xhs-pc-web; a1=18eef0ead48n8l9hhznt8d8ejbcdv5zx68wfcm1ek50000232031; webId=581213f27d64eab44c080c8487ebce63; gid=yYddi8dDK2KyyYddi8d0fY6y4YIY1jxxuI9YEdTfYdVDSi28fh2uCS888JqJ8qy8dqSWWYdd; unread={%22ub%22:%2265ffa8c30000000012023ba2%22%2C%22ue%22:%2265fe1d620000000012036241%22%2C%22uc%22:12}; websectiga=6169c1e84f393779a5f7de7303038f3b47a78e47be716e7bec57ccce17d45f99; sec_poison_id=e92be7ee-351b-4be0-9317-ce5eeda696e6'

let s = "/api/sns/web/v1/homefeed";
let i = {
    category:"homefeed_recommend",
    cursor_score:"1.6882971879610028E9",
    note_index:0,
    num:31,
    refresh_type:3,
    search_key:"",
...
function get_header(s,i){
    return window._webmsxyw(s,i)
}

console.log(get_header(s, i));
// console.log(window._webmsxyw('/api/sns/web/v1/homefeed',{"cursor_score":"","num":18,"refresh_type":1,"note_index":21,"unread_begin_note_id":"","unread_end_note_id":"","unread_note_count":0,"category":"homefeed.food_v3","search_key":"","need_num":8,"image_formats":["jpg","webp","avif"],"need_filter_image":false}))
